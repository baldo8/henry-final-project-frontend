    ...
    <div className="wrapper-PatientHome">
      <aside className="navigation-menu">
        ...
        <div className="actions">
          <a href="/patient/new_appointment">
            <svg xmlns="http://www.w3.org/2000/svg" width="23" height="22" viewBox="0 0 23 22" fill="none"><g clip-path="url(#clip0_257_4638)"><path d="M8.75 11H14.25" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M11.5 8.25V13.75" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M3.25 4.58333C3.25 4.0971 3.44315 3.63079 3.78697 3.28697C4.13079 2.94315 4.5971 2.75 5.08333 2.75H17.9167C18.4029 2.75 18.8692 2.94315 19.213 3.28697C19.5568 3.63079 19.75 4.0971 19.75 4.58333V17.4167C19.75 17.9029 19.5568 18.3692 19.213 18.713C18.8692 19.0568 18.4029 19.25 17.9167 19.25H5.08333C4.5971 19.25 4.13079 19.0568 3.78697 18.713C3.44315 18.3692 3.25 17.9029 3.25 17.4167V4.58333Z" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></g><defs><clipPath id="clip0_257_4638"><rect width="22" height="22" fill="white" transform="translate(0.5)"/></clipPath></defs></svg>
            Agendar Cita
          </a>
        </div>
      </aside>
